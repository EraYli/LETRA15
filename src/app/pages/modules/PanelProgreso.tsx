        ...
        <div className="max-w-[1200px] mx-auto flex flex-wrap items-center justify-between gap-y-2 gap-x-2 md:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 shrink-0">
            <Link
              ...
              className="flex items-center justify-center bg-white border-2 border-[#6B21A8] text-[#6B21A8] font-bold hover:bg-[#6B21A8] hover:text-white transition-colors no-underline text-[0.75rem] md:text-[0.9rem] px-3 py-1 md:px-4 md:py-1.5 rounded-full whitespace-nowrap"
            >
              Inicio
            </Link>
          </div>
